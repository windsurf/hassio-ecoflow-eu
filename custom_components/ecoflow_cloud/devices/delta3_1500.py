...
# ── Battery / BMS ──────────────────────────────────────────────────────────
# bms_bmsStatus.* is confirmed to arrive every ~5 minutes in the full status dump.
...
# bms_emsStatus.* is confirmed to arrive every ~5 minutes in the full status dump.
...
KEY_DC12V_STATE   = "mppt.carState"                 # DC 12V switch on/off     (0/1)
